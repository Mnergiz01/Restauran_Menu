...
=======
                ...
                <div class="ml-4">
                  <div class="text-sm font-medium text-gray-900">{{ product.name }}</div>
                  <div v-if="product.description" class="text-sm text-gray-500 truncate max-w-xs">{{ product.description
                    }}</div>
>>>>>>> 2247043 (Refactor)
                </div>
              </div>
...
=======
                  <strong>{{ productToDelete?.name }}</strong> ürününü silmek istediğinizden emin misiniz? Bu işlem geri
                  alınamaz.
>>>>>>> 2247043 (Refactor)
                </p>
              </div>
